// This file stores the direct links to your hosted images.
//
// RECOMMENDED HOSTING: Cloudinary (https://cloudinary.com)
// 1. Create a free Cloudinary account.
// 2. Go to the "Media Library" and upload your images.
// 3. Click an image, find the "Secure URL", and copy it.
// 4. Paste the direct links below.

export const INTRO_IMAGE_URL = "https://res.cloudinary.com/dnpjnknro/image/upload/v1765741271/intro_zmc0ue.jpg";
